#!/usr/bin/env python3
"""
Free Proxy Scraper — aggregates from multiple sources.
...
def filter_valid(proxies: Set[str], max_check: int = 300) -> List[str]:
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Free Proxy Scraper")
    parser.add_argument("-o", "--output", default="proxies.txt")
    parser.add_argument("--validate", action="store_true")
    parser.add_argument("--max-validate", type=int, default=300)
