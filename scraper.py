...
PROXY_SOURCES = [
    ...
    # R26-Z4: negara EU+Asia tambahan (verified 2026-08-11 live: proxifly/geonode/psv4)
    ("proxifly-country-PT", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/PT/data.txt", "host:port"),
    ("proxifly-country-GR", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/GR/data.txt", "host:port"),
    ("proxifly-country-DK", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/DK/data.txt", "host:port"),
    ("proxifly-country-NO", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/NO/data.txt", "host:port"),
    ("proxifly-country-SK", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/SK/data.txt", "host:port"),
    ("proxifly-country-SI", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/SI/data.txt", "host:port"),
    ("proxifly-country-BA", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/BA/data.txt", "host:port"),
    ("proxifly-country-RS", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/RS/data.txt", "host:port"),
    ("proxifly-country-EE", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/EE/data.txt", "host:port"),
    ("proxifly-country-CY", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/CY/data.txt", "host:port"),
    ("proxifly-country-LU", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/LU/data.txt", "host:port"),
    ("proxifly-country-AL", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/AL/data.txt", "host:port"),
    ("proxifly-country-JP", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/JP/data.txt", "host:port"),
    ("proxifly-country-TW", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/TW/data.txt", "host:port"),
    ("proxifly-country-MY", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/MY/data.txt", "host:port"),
    ("proxifly-country-PH", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/PH/data.txt", "host:port"),
    ("proxifly-country-VN", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/VN/data.txt", "host:port"),
    ("proxifly-country-IN", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/IN/data.txt", "host:port"),
    ("proxifly-country-PK", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/PK/data.txt", "host:port"),
    ...
    ("proxifly-country-TR", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/TR/data.txt", "host:port"),
    ("proxifly-country-AE", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/AE/data.txt", "host:port"),
    ...
    ("proxifly-country-IL", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/IL/data.txt", "host:port"),
    ("proxifly-country-KZ", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/KZ/data.txt", "host:port"),
    ("geonode-DK", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=DK", "geonode"),
    ("geonode-SI", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=SI", "geonode"),
    ("geonode-HR", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=HR", "geonode"),
    ("geonode-BA", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=BA", "geonode"),
    ("geonode-EE", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=EE", "geonode"),
    ("geonode-CY", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=CY", "geonode"),
    ("geonode-AL", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=AL", "geonode"),
    ("geonode-MD", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=MD", "geonode"),
    ("geonode-JP", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=JP", "geonode"),
    ("geonode-TW", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=TW", "geonode"),
    ("geonode-MY", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=MY", "geonode"),
    ("geonode-PH", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=PH", "geonode"),
    ("geonode-VN", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=VN", "geonode"),
    ("geonode-IN", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=IN", "geonode"),
    ("geonode-PK", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=PK", "geonode"),
    ("geonode-BD", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=BD", "geonode"),
    ("geonode-LK", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=LK", "geonode"),
    ("geonode-TR", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=TR", "geonode"),
    ("geonode-AE", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=AE", "geonode"),
    ("geonode-IL", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=IL", "geonode"),
    ("geonode-KZ", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=KZ", "geonode"),
    ("geonode-UZ", "https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc&protocols=http,socks4,socks5&country=UZ", "geonode"),
    ("psv4-country-PT", "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text&protocol=http&country=PT&timeout=5000", "protocolipport"),
    ("psv4-country-HR", "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text&protocol=http&country=HR&timeout=5000", "protocolipport"),
    ("psv4-country-RS", "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text&protocol=http&country=RS&timeout=5000", "protocolipport"),
    ("psv4-country-EE", "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text&protocol=http&country=EE&timeout=5000", "protocolipport"),
    ("psv4-country-CY", "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text&protocol=http&country=CY&timeout=5000", "protocolipport"),
    ...
    ("hproxy-country-NG", "https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/by-country/NG.txt", "host:port"),
    ("hproxy-country-GH", "https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/by-country/GH.txt", "host:port"),
    ("hproxy-country-BW", "https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/by-country/BW.txt", "host:port"),
    ("hproxy-country-TZ", "https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/by-country/TZ.txt", "host:port"),
    ("hproxy-country-SN", "https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/by-country/SN.txt", "host:port"),
    # proxifly country files Afrika (verified 2026-08-11: ZA 22, NG 4, EG 3 raw)
    ...
    # by 2/2, do 1/5, ly 1/3, am 1/1, gt 1/3, ma 1/1, ng 1/1, py 1/4, se 1/6,
    # sy 1/5, ve 2/6, pl 1/5)
    ("dlb-country-EC", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ec/http.txt", "host:port"),
    ("dlb-country-ID", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/id/http.txt", "host:port"),
    ("dlb-country-RU", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ru/http.txt", "host:port"),
    ("dlb-country-SG", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/sg/http.txt", "host:port"),
    ("dlb-country-TR", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/tr/http.txt", "host:port"),
    ("dlb-country-US", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/us/http.txt", "host:port"),
    ("dlb-country-VN", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/vn/http.txt", "host:port"),
    ("dlb-country-TH", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/th/http.txt", "host:port"),
    ("dlb-country-IR", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ir/http.txt", "host:port"),
    ("dlb-country-KZ", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/kz/http.txt", "host:port"),
    ("dlb-country-BD", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/bd/http.txt", "host:port"),
    ("dlb-country-KR", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/kr/http.txt", "host:port"),
    ("dlb-country-MY", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/my/http.txt", "host:port"),
    ("dlb-country-PH", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ph/http.txt", "host:port"),
    ("dlb-country-IN", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/in/http.txt", "host:port"),
    ("dlb-country-VE", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ve/http.txt", "host:port"),
    ("dlb-country-SY", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/sy/http.txt", "host:port"),
    ("dlb-country-BY", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/by/http.txt", "host:port"),
    ("dlb-country-DO", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/do/http.txt", "host:port"),
    ("dlb-country-LY", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ly/http.txt", "host:port"),
    ("dlb-country-SE", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/se/http.txt", "host:port"),
    ("dlb-country-PL", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/pl/http.txt", "host:port"),
    ("dlb-country-GT", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/gt/http.txt", "host:port"),
    ("dlb-country-MA", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ma/http.txt", "host:port"),
    ("dlb-country-NG", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/ng/http.txt", "host:port"),
    ("dlb-country-PY", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/py/http.txt", "host:port"),
    ("dlb-country-AM", "https://raw.githubusercontent.com/databay-labs/free-proxy-list/master/by-country/am/http.txt", "host:port"),
    ...
    ("gnx-live2-http", "https://raw.githubusercontent.com/gnxD3RfTT2WE/live-socks5-proxies/main/http.txt", "host:port"),
    ...
    # ── R38-S1: stabilitas — CI harian aktif + alive-tested + mirror CDN (verified 2026-08-12)
    ("thordata-all", "https://raw.githubusercontent.com/Thordata/awesome-free-proxy-list/main/proxies/all.txt", "host:port"),
    ("thordata-top-http", "https://raw.githubusercontent.com/Thordata/awesome-free-proxy-list/main/proxies/top-http.txt", "host:port"),
    ("webunblocker-all", "https://raw.githubusercontent.com/webunblocker/free-proxy-list/main/proxies/all/data.txt", "host:port"),
    ("trio666-all", "https://raw.githubusercontent.com/trio666/proxy-checker/main/all.txt", "host:port"),
    ("trio666-http", "https://raw.githubusercontent.com/trio666/proxy-checker/main/http.txt", "host:port"),
    ...
    ("proxifly-country-LY-raw", "https://raw.githubusercontent.com/proxifly/free-proxy-list/main/proxies/countries/LY/data.txt", "host:port"),
